...
fetchMock.patch(`${apiServer}/todos/1`, item)
fetchMock.patch(`${apiServer}/todos/2`, { status: 400, body: msg400 })
fetchMock.patch(`${apiServer}/todos/3`, { status: 404, body: msg404 })

fetchMock.delete(/\/todos\/[0-9]{1,}/, delete200)
